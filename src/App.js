...
const App = () => {
  ...
  const ALLTABLES = ['Exercises', 'BodyParts', 'Workouts', 'Users', 'UserWorkouts']
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="/UserWorkouts" element={<JunctionTable attr={all_attr['UserWorkouts']} rt="/UserWorkout" name="UserWorkout" />} />
      </Route>
    </Routes>
  );
}
